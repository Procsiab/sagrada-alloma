...
/**
 * <h1>Network Abstract Class</h1>
 * <p>This class will hold general network parameters and methods, to be shared between client and server.</p>
 * <p>Specific extensions of this class are {@link client.network.NetworkClient} and {@link server.network.NetworkServer};<br>
 ...
 * @see client.network.NetworkClient
 */
//TODO Implement socket networking
public abstract class Network {
    ...
    protected static Network instance = null;
    private String IP;
